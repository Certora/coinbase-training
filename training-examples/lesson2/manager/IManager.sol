...
interface IManager {
  ...
  /// @dev The message sender may not manage another fund and may not be address(0)
  ...
  /// @dev Only the fund's manager may set the pending manager, the pending manager
  /// may not be address(0)
